        ...
        <div class="col-sm-8 pt-3">
            <div id="postSection" class="light-bold">
                <div class="postContent{{$post->id}} mb-2">
                        ...
                        <p class="post-desc break-word mt-2 text-justify">{!! nl2br(e($post->description)) !!}</p>
                        <div class="text-center">
                            <a data-toggle="modal" data-target="#postImageModal" class="blue-text">
                    ...
                    <p class="post-sDesc break-word break-word text-justify">{!! nl2br(e($post->shortDesc)) !!}</p>
                        <div id="social-links">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="postImageModal" tabindex="-1" role="dialog" aria-labelledby="{{$post->caption}}" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-body" >
                                       
                                <img src="{{asset($post->image)}}" alt="{{$post->caption}}" class="img-fluid" >
                                </div>
                              </div>
                            </div>
                          </div>
